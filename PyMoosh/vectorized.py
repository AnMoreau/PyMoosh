...
def angular(structure, wavelength, polarization, theta_min, theta_max, len_an, method="S"):
    """
        Wrapper to choose between S matrices (stability) and Abélès (speeeed)
    """
    if (method == "S"):
        return angular_S(structure, wavelength, polarization, theta_min, theta_max, len_an)
    elif (method == "A"):
        return angular_A(structure, wavelength, polarization, theta_min, theta_max, len_an)
