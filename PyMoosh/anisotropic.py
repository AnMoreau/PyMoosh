...
class AniStructure(Structure):
    ...
    def permittivity_tensor_list(self, wavelength, layer=None):
...
def Halfspace_method(struct, layer_number, wl, theta_entry):
    """
...
def Berreman_method(struct, layer_number, wl, theta_entry):
    """
