...
mat1 = PM.Material([models.Drude, 1e10, 1e5], specialType="Model")
...
wavelength, sr, st, sR, sT = PM.spectrum_S(interface, 0, 0., 400., 800., 20)
# # For TM polarization, same incidence angles
# wavelength, sr_p, st_p, sR_p, sT_p = PM.spectrum_S(interface, 0, 1., 400., 800., 200)

# wavelength, ar, at, aR, aT = PM.spectrum_A(interface, 0, 0., 400., 800., 200)
# # For TM polarization, same incidence angles
# wavelength, ar_p, at_p, aR_p, aT_p = PM.spectrum_A(interface, 0, 1., 400., 800., 200)
...
# For TE polarization
angles, sr, st, sR, sT = PM.angular_S(interface, wavelength, 0., 0., 89., 20)
# For TM polarization, same incidence angles
angles, sr_p, st_p, sR_p, sT_p = PM.angular_S(interface, wavelength, 1., 0., 89., 20)

angles, ar, at, aR, aT = PM.angular_A(interface, wavelength, 0, 0., 89., 20)
# For TM polarization, same incidence angles
angles, ar_p, at_p, aR_p, aT_p = PM.angular_A(interface, wavelength, 1., 0., 89., 20)
