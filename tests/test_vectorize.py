...
interface = PM.Structure(materials,stack,epaisseurs, verbose=False, si_units=True)


wavelength, sr, st, sR, sT = vec.spectrum_S(interface, 0, 0., 400., 800., 200)
...
# For TE polarization
angles, sr, st, sR, sT = vec.angular_S(interface, wavelength, 0., 0., 89., 200)
# For TM polarization, same incidence angles
angles, sr_p, st_p, sR_p, sT_p = vec.angular_S(interface, wavelength, 1., 0., 89., 200)

angles, ar, at, aR, aT = vec.angular_A(interface, wavelength, 0, 0., 89., 200)
# For TM polarization, same incidence angles
angles, ar_p, at_p, aR_p, aT_p = vec.angular_A(interface, wavelength, 1., 0., 89., 200)
