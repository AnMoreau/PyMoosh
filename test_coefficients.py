...
r, t, R, T = PM.coefficient(chose,wav,incidence,0)



chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_ab, t_ab, R_ab, T_ab = PM.abeles_coefficient(chose1,wav,incidence,0)


chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_t, t_t, R_t, T_t = PM.TMatrix_coefficient(chose1,wav,incidence,0)


chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_dn, t_dn, R_dn, T_dn = PM.DirToNeu_coefficient(chose1,wav,incidence,0)
...
chose = PM.Structure(materials,stack,epaisseurs, verbose=False)
r, t, R, T = PM.coefficient(chose,wav,incidence,1)



chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_ab, t_ab, R_ab, T_ab = PM.abeles_coefficient(chose1,wav,incidence,1)


chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_t, t_t, R_t, T_t = PM.TMatrix_coefficient(chose1,wav,incidence,1)


chose1 = PM.Structure(materials,stack,epaisseurs, verbose=False)
r_dn, t_dn, R_dn, T_dn = PM.DirToNeu_coefficient(chose1,wav,incidence,1)
