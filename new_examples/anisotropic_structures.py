...
thickness = [
    ...
    25,
    0,
]  # The thickness of each layer (as in the usual Structure function)
ani_rot_angle = [
    0.0,
    0.5,
    -0.2,
    0.0,
]  # The rotation angle for each layer. MUST be provided for isotropic layers too, will simply be overlooked
ani_rot_axis = [
    "z",
    "x",
    [0, 1, 1],
    "z",
]  # The rotation axis for each layer. MUST be provided for isotropic layers too, will simply be overlooked
